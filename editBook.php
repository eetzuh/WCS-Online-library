    ...
    <div class='mt flex-js-center'>
        <div class='add-book-div flex-js-center'>
            <div class='add-book-form'>
                <form action="./editDB.php" class='add-book-form' id='editForm' method="post"></form>
                <form action="./deleteBook.php" id='deleteForm'></form>
                <div class='flex-col'>
                    <label for="bookName">Naziv knjige</label>
                    <input form='editForm' type="text" name="bookName" id="text-input" class='mt-5' value='<?php echo (htmlspecialchars($bookName)); ?>' required>
                </div>
                    ...
                    <div class='selectedItems mt-5'>
                        ...
                        <div id='selected-author' class='selectedItems wrap mt-5'>
                            ...
                            foreach ($authors as $author) {
                                echo '<div onclick="this.remove()"><label for="previous_author" class="added_author" onclick="this.remove()">' . $author . '</label>
                ...
                <div class='flex-col inputs-div'>
                    <label for="selectCategory">Žanr</label>
                        <div class='selectedItems mt-5'>
                            ...
                            foreach ($categories as $category) {
                                echo '<div onclick="this.remove()"><label for="previous_category" class="added_category">' . $category . '</label>
                    ...
                    <div class='flex-js-center inputs-div mt-5'>
                        ...
                        <input form='editForm' type="number" name="number_of_pages" max='9999' min='1' id="number_input" value='<?php echo $pages ?>' required>


                        <label for="publication_date">Datum izdanja</label>
                        <input form='editForm' type="date" name="publication_date" id="date_input" value='<?php echo $publicationDate ?>' required>

                        <label for="quantity">Količina</label>
                        <input form='editForm' type="number" name="quantity" max='9999' min='1' id="number_input" value='<?php echo $quantity ?>' required>
                    </div>
                    <div class='flex-col inputs-div mt-5'>
                        <label for="description">Opis</label>
                        <textarea form='editForm' class='book-description-field' name="description" cols="30" rows="8" placeholder="Add description" required><?php echo $description ?></textarea>
                    </div>
                    <?php
                    ...
                    <div class='inputs-div flex-end'>
                        <button type='submit' onclick='checkFields("editForm")' id='add-book-button' form='editForm'>Uredi knjigu</button>
                    </div>
