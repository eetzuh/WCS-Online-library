...
<body>
    ...
    <div class='mt flex-js-center'>
        <div class='add-book-div flex-js-center'>
                <form action="./addBook.php" class='add-book-form' method="post">
                        <div class='flex-col'>
                            <label for="bookName">Naziv knjige</label>
                            <input type="text" name="bookName" id="text-input">
                        </div>
                        <div class='flex-col inputs-div'>
                            <label for="author">Autor</label>
                            <select name="selectAuthor" id="select-author">
                        ...
                        <div class='flex-js-center inputs-div'>
                            ...
                            <input type="number" name="number_of_pages" max='9999' min='1' id="number_input">
    
                            <label for="publication_date">Datum izdanja</label>
                            <input type="number" name="publication_date" max='9999' min='1' id="number_input">
    
                            <label for="quantity">Količina</label>
                            <input type="number" name="quantity" max='9999' min='1' id="number_input">
                        </div>
                        <div class='flex-col inputs-div'>
                            <label for="description">Opis</label>
                            <textarea class='book-description-field' name="text" id="text" cols="30" rows="8" placeholder="Add description"> </textarea>
                        </div>
                        <?php
